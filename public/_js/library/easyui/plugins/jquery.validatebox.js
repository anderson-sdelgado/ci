...
$.fn.validatebox.defaults={required:false,validType:null,missingMessage:"Este campo é obrigatório.",invalidMessage:null,rules:{email:{validator:function(_1f){
...
},message:"Digite um endereço de e-mail válido."},url:{validator:function(_20){
...
},message:"Por favor, digite uma URL válida."},length:{validator:function(_21,_22){
var len=$.trim(_21).length;
return len>=_22[0]&&len<=_22[1];
},message:"Por favor insira um valor entre {0} e {1}."},remote:{validator:function(_23,_24){
var _25={};
_25[_24[1]]=_23;
var _26=$.ajax({url:_24[0],dataType:"json",data:_25,async:false,cache:false,type:"post"}).responseText;
return _26=="true";
},message:"Corrija este campo."}}};
})(jQuery);
