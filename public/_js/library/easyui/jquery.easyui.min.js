...
$.fn.validatebox.defaults={required:false,validType:null,missingMessage:"Este campo é obrigatório.",invalidMessage:null,rules:{email:{validator:function(_32f){
...
},message:"Digite um endereço de e-mail válido."},url:{validator:function(_330){
...
},message:"Por favor, digite uma URL válida."},length:{validator:function(_331,_332){
var len=$.trim(_331).length;
return len>=_332[0]&&len<=_332[1];
},message:"Por favor insira um valor entre {0} e {1}."},remote:{validator:function(_333,_334){
var data={};
data[_334[1]]=_333;
