...
class Admin_Model_Cargosinformativositem extends Admin_Model_Abstract{

    public function __construct() {
        $this->_dbTable = new Admin_Model_DbTable_Cargosinformativositem();
        $this->_table = "CARGOS_INFORMATIVOS_ITEM";
    }
